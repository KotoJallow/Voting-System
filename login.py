...
class Ui_MainForm(object):
    def setupUi(self, MainForm):
        ...
        self.MainFrame.setStyleSheet("background-color: rgb(55, 100, 205);")
...
"")
        ...
        self.lineEditUserName.setStyleSheet("background-color: orange;\n"
"border-style: outset;\n"
"border-width: 2px;\n"
"border-radius: 15px;\n"
"border-color: black;\n"
"padding: 4px;")
        ...
        self.lineEditPassword.setStyleSheet("background-color: orange;\n"
"border-style: outset;\n"
"border-width: 2px;\n"
"border-radius: 15px;\n"
"border-color: black;\n"
...
"text-align: center;")
        ...
        self.btnLogIn.setStyleSheet("background-color: rgb(202, 78, 34);\n"
"color: white;")
        self.btnLogIn.setObjectName("btnLogIn")
        self.btnRegister = QtWidgets.QPushButton(self.frameBody)
        self.btnRegister.setGeometry(QtCore.QRect(130, 120, 111, 41))
        self.btnRegister.setStyleSheet("background-color: rgb(202, 78, 34);\n"
"color: white;\n"
"border-style: outset;\n"
"border-width: 2px;\n"
"border-radius: 15px;\n"
...
"text-align: center;")
        ...
        self.btnTitle.setStyleSheet("background-color: #262626;\n"
...
"text-align: center;")
    ...
    def retranslateUi(self, MainForm):
        ...
        self.lineEditUserName.setPlaceholderText(_translate("MainForm", "Enter username"))
